...
string setcolor(int elem) {
	...
	*/
	if (elem == -1) { return "\033[0m"; } // 重置颜色
	else if (elem == 2) { return "\033[1;30;47m"; } // 黑字白底
	else if (elem == 4) { return "\033[1;37;46m"; }  // 白字青底
	else if (elem == 8) { return "\033[1;37;42m"; } // 白字绿底
	else if (elem == 16) { return "\033[1;37;46m"; } // 白字青底
	else if (elem == 32) { return "\033[1;37;44m"; } // 白字蓝底
	else if (elem == 64) { return "\033[1;37;45m"; } // 白字紫底
	else if (elem == 128) { return "\033[1;30;43m"; } // 黑字黄底
	else if (elem == 256) { return "\033[1;30;42m"; } // 黑字绿底
	else if (elem == 512) { return "\033[1;37;41m"; } // 白字红底
	else if (elem == 1024) { return "\033[1;37;43m"; } // 白字黄底
	else if (elem == 2048) { return "\033[1;37;41m"; } // 白字红底（强调最终目标）
}
